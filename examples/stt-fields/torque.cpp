...
int main(void)
{
    ...
    mtj.setLayerAnisotropyDriver("free", ScalarDriver<double>::getConstantDriver(Ku));
    ...
    for (auto &f : frequencies)
    {
        ...
        for (auto &H : Hdist)
        {
            ...
            // ScalarDriver<double>::getSineDriver(0, 1000, f, 0), NullDriver<double>(), NullDriver<double>());
            ...
            // const double maxR = *std::max_element(log[resTag].begin(), log[resTag].end());
            // std::cout << "Max V: " << maxV << "; Max R: " << maxR << std::endl;
