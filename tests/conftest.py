...
def single_layer_mtj() -> Tuple[Junction, ResistanceParameters]:
    ...
    junction.setLayerAnisotropyDriver("free",
                                      ScalarDriver.getConstantDriver(K1))
...
def two_layer_mtj() -> Tuple[Junction, ResistanceParameters]:
    ...
    junction.setLayerAnisotropyDriver("bottom",
                                      ScalarDriver.getConstantDriver(K2))
    junction.setIECDriver("free", "bottom", ScalarDriver.getConstantDriver(J1))
    junction.setQuadIECDriver("free", "bottom",
                              ScalarDriver.getConstantDriver(J2))
...
def tri_layer_mtj() -> Tuple[Junction, ResistanceParameters]:
    ...
    for l, anis_val in zip(["free", "middle", "bottom"], [K1, K2, K3]):
        junction.setLayerAnisotropyDriver(
            l, ScalarDriver.getConstantDriver(anis_val))

    junction.setIECDriver("free", "middle",
                          ScalarDriver.getConstantDriver(J11))
    junction.setQuadIECDriver("free", "middle",
                              ScalarDriver.getConstantDriver(J12))

    junction.setIECDriver("middle", "bottom",
                          ScalarDriver.getConstantDriver(J21))
    junction.setQuadIECDriver("middle", "bottom",
                              ScalarDriver.getConstantDriver(J22))
